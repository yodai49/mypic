...
const eventobj=[
    [[30,30,50,50,1],[100,30,50,50,2],[170,30,50,50,3,0]],//フィールドのイベント場所のデータ　[x,y,width,height,eventnum,shopnum]
    []
]
...
const itemdata=[ //[0:アイテム名,1:フィールドで使用可能?(off:0,on:1),2:バトルで使用可能？(off:0,on:1), 3:説明 4:たまごならたまご番号　それ以外は-1
    ...
    ["アタックブースト",0,1,"攻撃力を一時的に強化する。",-1],//10
    ["ガードブースト",0,1,"防御力を一時的に強化する。",-1],
    ["プロテイン",0,1,"最大HPを一時的に増加する。",-1], //12
    ...
    ["魔窟の闇に埋もれた卵",0,0,"洞窟ダンジョンの奥に眠るたまご。孵化させると強力なマイピクになり仲間に加えられる。",1],//20
    ...
    ["レアな木の卵",0,0,"ダンジョンで稀に手に入るたまご。孵化させると少し強いマイピクになり仲間に加えられる。",11],//30
