...
const fieldbackdata=[ //フィールドの背景の長方形データをすべて格納（主に歩ける部分）
    ...
    [["fieldbackobj1"]],[["fieldbackobj1"]],[["fieldbackobj1"]],[["fieldbackobj1"]],[["fieldbackobj1"]],[["fieldbackobj1"]],[["fieldbackobj1"]],[["fieldbackobj1"]],[["fieldbackobj1"]],[["fieldbackobj1"]],
...
const fieldwarpobj=[
    ...
    [],[],[],[],[],//0-9
    [[0,0,880,15,11,480,480],[945,0,15,540,2,40,270],[411,483,149,15,20,480,40]],
]
const eventobj=[//フィールドのイベント場所のデータ　[x,y,width,height,eventnum,(shopnum,move Item Num),はじき出される方向(左右上下の順)]
    [[339,186,70,90,2],[378,128,126,10,1]],[[282,252,107,116,3,0]],
    [[221,18,300,15,4,0,3]],[],[[199,338,93,26,3,1],[594,199,94,46,3,2]],[],[],[],[],[],
    [],[],[],[],[],[],[],[],[],[],//10
    [],[],[],[],[],[],[],[],[],[],//20
    [],[],[],[],[],[],[],[],[],[],//30
    [],[],[],[],[],[],[],[],[],[],//40
...
var shopData=[ ////[[itemNum,price,stock(未使用?)]]
    [[0,50,99],[3,50,99],[4,200,99],[5,300,99],[6,300,99]],//0号店
    [[0,50,99],[3,50,99],[4,200,99],[5,300,99],[6,300,99],[12,300,99],[13,300,99]],//1号店
    [[0,50,99],[3,50,99],[4,200,99],[5,300,99],[6,300,99],[7,50,99],[8,50,99],[9,200,99],[12,300,99],[13,300,99]],//2号店
    [],
    []
]
////////////////////
