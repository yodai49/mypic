...
const eventobj=[    //x,y,width,height,eventnum,...（下部参照）
    [[339,186,70,90,2],[378,148,126,10,1],[339,286,30,30,6,0,-1]],[[282,252,107,116,3,0]],
    [[221,18,300,15,4,42,3]],[],[[199,338,93,26,3,1],[594,199,94,66,3,2],[215,18,490,16,4,44,3],[891,122,35,316,4,43,0]],[],[],[],[],[],
    [[381,453,209,30,4,42,2]],[],[],[],[],[[906,57,35,300,4,42,0],[322,364,95,15,3,3]],[[874,251,33,200,4,42,0]],[],[[278,226,60,15,5,0]],[],//10-19
    [],[],[],[],[[670,112,58,20,3,3]],[],[],[[453,329,62,15,5,0]],[],[],//20
    [],[[434,76,67,13,3,4]],[],[[688,86,67,15,3,5]],[],[],[[638,487,320,30,4,44,2],[249,154,64,15,3,6],[568,154,66,15,3,7],[513,362,93,20,3,8]],[],[],[],//30
    [],[],[],[],[],[[455,341,160,18,3,9]],[],[],[],[],//40
    [],[],[],[],[],[],[],[],[],[]//50
]
...
//              5　欠番（ボス戦はメッセージに統合）
//              6 メッセージ        x,w,width,height,6,eventMsgの番号,イベント回避のためのアイテム
...
const enemyData=[
    ...
    /////////////////////
    //ラスボス,中ボス
    ["ラスボス",[],[400,0],[400,0],500,500,[200,0],[230,0],[16,31,52,53],70,165,0,[69,0],0,4,6,50,100,0,0,0,0],
    ["森の化身 ダークフォレスト",[],[75,0],[75,0],150,150,[40,0],[60,0],[16,31,52,53],6,35,0,[20,0],0,4,3,21,100,42,100,46,100],
    ["洞窟の要 ケイブレイア",[],[120,0],[120,0],200,200,[75,0],[100,0],[45,46,47,51],7,70,0,[35,0],0,4,5,22,100,43,100,47,100],
    ["遺跡の あああ",[],[220,0],[220,0],350,350,[125,0],[140,0],[15,16,17,51],8,98,0,[48,0],0,4,1,23,100,44,100,48,100],
    ["砂漠の真相 うおおん",[],[285,0],[285,0],450,450,[160,0],[185,0],[23,38,39,51],9,130,0,[59,0],0,4,4,24,100,45,100,49,100],
    /////////////////////

    /////////////////////
    //森ダンジョンのみ出現
    ["Fnormal1",[],[20,1],[20,1],50,50,[12,2],[14,2],[0,1,2,3],0,12,0,[3,2],0,4,0,4,10,0,0,0,0],
    ...
    ["Fwater1",[],[65,5],[65,5],100,100,[33,1],[50,1],[2,18,19,49],5,28,0,[17,1],0,4,2,31,30,36,20,26,50],
    /////////////////////

    /////////////////////
    //洞窟ダンジョンのみ出現
    ["Cnormal1",[],[60,3],[60,3],100,100,[45,2],[50,2],[0,1,2,3],0,35,0,[17,2],0,4,0,4,20,0,0,0,0],
    ...
    /////////////////////
    //遺跡ダンジョンのみ出現
    ["Tnormal1",[],[100,4],[100,4],200,200,[75,2],[80,2],[2,3,4,5],0,63,0,[31,2],0,4,0,5,10,0,0,0,0],
    ...
    /////////////////////
    //砂漠ダンジョンのみ出現
    ["Dnormal1",[],[130,5],[135,5],300,300,[100,2],[110,2],[3,5,6,20],0,80,0,[45,2],0,4,0,5,20,0,0,0,0],
...
//上限133文字
const eventMsgText=[ /////戦闘が始まる時は "*XXX"　の書式（XXXは敵の番号）
    [   "朝だ。",
        "今日は何か荷物が届く日だったか。見に行ってみよう",
        "方向キー：移動　Z：アクション　X：キャンセル　C：メニューを開く"
        ],//0
    [   "届いた荷物の中身はいくつかあるようだ。",
    ...
    [   "...",
        ...
        "まずはそこに行ってみよう。"],//7
    [   "ん？何やらものが落ちてるぞ？",
        "memo2には何が書いてあるんだろう..."],//8
    [   "最近、一部地域で流行しているマイピクの不可解な現象についに専門チームが動いた。",
        "現在行政から派遣された研究員が調査にあたっているが未だ原因は解明されていない。",
        "その地域に住んでいるマイピクの第一人者は数ヶ月前にマイピクのエネルギー開発利用に成功しているが、その女性は突然姿を眩まし、今も行方不明となっている。"],//8
    [   "そこには新聞が落ちていた。",
        "新聞が発行されたのはおよそ10年前。",
        "母親からの手紙の年数と一致する。",
        "一体どんな事件なんだ？",
