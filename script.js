...
var mypicstock=[
    ["ああああああ",[[0,10,30,25,15],[0,25,15,40,30],[0,60,30,75,15],[0,75,15,90,30],[0,30,70,50,90],[0,50,90,70,70]],250,300,50,50,100,100,[4,20,30,40],5,100,3,2,120,4,0,0],
...
function init() {
    ...
    function tick() { //メイン関数
        ...
        if(bkey) mode=2, onMessage=true,battleLaunchFlg=1;//バトル開始の処理
