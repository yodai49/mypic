...
const fieldenemyDataSet=[ //出会う敵の確率 [Num,odds]の形で格納 oddsの総和はなんでもよい
    [], //敵が出ないゾーン
    [[9,3],[10,3],[11,3],[13,2],[14,2],[18,3]],//森１　手前
    [[9,2],[10,2],[12,3],[13,1],[14,1],[15,2],[16,0.5],[18,3]],//森２　奥
    [[9,2],[10,2],[12,3],[13,1],[14,1],[15,2],[16,1],[17,0.25],[18,2]],//森３　崖
    [[19,3],[20,3],[21,3],[23,2],[24,2],[28,3]],//洞窟１　手前
    [[19,2],[20,2],[22,3],[23,1],[24,1],[25,2],[26,0.5],[28,3]],//洞窟２　奥 _//////////////    5
    [[19,2],[20,2],[22,3],[23,1],[24,1],[25,2],[26,1],[27,0.25],[28,2]],//洞窟３　レアゾーン
    [[29,3],[30,3],[31,3],[33,2],[34,2],[38,3]],//都市１　手前
    [[29,2],[30,2],[32,3],[33,1],[34,1],[35,2],[36,0.5],[38,3]],//都市２　奥
    [[29,2],[30,2],[32,3],[33,1],[34,1],[35,2],[36,1],[37,0.25],[38,2]],//都市３　レアゾーン
    [[39,3],[40,3],[41,3],[43,2],[44,2],[48,3]],//砂漠１　手前               _//////////////    10
    [[39,2],[40,2],[42,3],[43,1],[44,1],[45,2],[46,0.5],[48,3]],//砂漠２　奥
    [[39,2],[40,2],[42,3],[43,1],[44,1],[45,2],[46,1],[47,0.25],[48,2]],//砂漠３　レアゾーン
]
const fieldwarpobj=[
...
const itemdata=[ //[0:アイテム名,1:フィールドで使用可能?(off:0,on:1),2:バトルで使用可能？(off:0,on:1), 3:説明 4:たまごならたまご番号　それ以外は-1
    ...
    ["よくある岩の卵",0,0,"ダンジョンでよく手に入るたまご。孵化させるとマイピクになり仲間に加えられる。",8],//31
