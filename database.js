...
const eventobj=[
    [[80,80,50,50,4,-1,3],[100,30,50,50,2],[170,30,50,50,3,0]],//フィールドのイベント場所のデータ　[x,y,width,height,eventnum,(shopnum,move Item Num),はじき出される方向(左右上下の順)]
    []
]
...
const itemdata=[ //[0:アイテム名,1:フィールドで使用可能?(off:0,on:1),2:バトルで使用可能？(off:0,on:1), 3:説明 4:たまごならたまご番号　それ以外は-1
    ...
    ["プロテイン",0,1,"最大HPを一時的に増加する。",-1], //13
    ["金運の知らせ",0,1,"敵を倒したときの獲得マイルがアップする。",-1],
    ["マスターの指導書",0,1,"敵を倒したときの獲得経験値がアップする。",-1],
